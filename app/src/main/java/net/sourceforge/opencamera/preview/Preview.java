...
public class Preview implements SurfaceHolder.Callback, TextureView.SurfaceTextureListener {
    ...
    public void getMeasureSpec(int [] spec, int widthSpec, int heightSpec) {
        ...
        // gemini_81dlp: Force full-container filling for VR Side-by-Side view
        spec[0] = widthSpec;
        spec[1] = heightSpec;
        return; //gemini_81dlp
    ...
    */
    ...
    private void configureTransform() {
        ...
        // gemini_81dlp: Synchronize transformation matrix to fix 90-degree rotation on right eye
        try {
            ...
            if (rightContainer != null) {
                ...
                if (rightEyeView != null) {
                    rightEyeView.setTransform(matrix);
                }
            }
        } catch (Exception ignored) {} //gemini_81dlp
    }
